...
<div class="right">
        ...
        <div class="providerAdd">
           <form id="providerForm" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/provideradd.do"
           enctype="multipart/form-data">
			<input type="hidden" name="method" value="add">
                ...
                <div>
                  ...
                  <div>
                    <label for="companyLicPicPath">营业执照：</label>
